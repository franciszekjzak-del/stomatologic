...
const FIELDS_24H = ["{imie}", "{data_wizyty}", "{godzina_wizyty}", "{link_potwierdzenia}", "{nazwa_gabinetu}", "{adres}", "{telefon_gabinetu}"];
...
const preview = (tpl) =>
  (tpl || "")
    ...
    .replace(/{link_potwierdzenia}/g, "recalldent.pl/potwierdz/x9y8");
  ...
  return (
    <div data-testid="templates-page">
      <PageHeader
        ...
        action={isOwner && <Button data-testid="save-templates-btn" onClick={save} className="gap-2"><Save className="h-4 w-4" /> Zapisz</Button>}
      />
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <Card className="shadow-none p-5 lg:col-span-2" data-testid="sms-24h-card">
          ...
          <p className="text-sm text-muted-foreground mb-3">Wysyłany automatycznie o 09:00 dzień przed każdą zarezerwowaną wizytą (raz na wizytę). Pacjent może odpowiedzieć TAK/NIE lub kliknąć link potwierdzenia — status widoczny w „Nadchodzące wizyty”.</p>
